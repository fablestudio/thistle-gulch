        ...
        async def on_tick(bridge: RuntimeBridge, current_time: datetime.datetime):
            ...
            if intro_step == 1:
                ...
                await bridge.runtime.api.modal(
                    ...
                    "generate multiple actions and score them using the Bridge. This time and incurs LLM costs.\n\n"
                ...
                await bridge.runtime.api.modal(
                    ...
                    "See the WIKI for more information on the using the runtime, the characters, and more. "
                    "We hope you enjoy using the SAGA server and the Fable Saga platform!\n\n"
